...
public class Asignaturas {
    ...
    public static void main(String[] args) {
        ...
        switch (dia) {
            case "Lunes" ->
                System.out.println("Ese día toca: " + Lunes);
            case "Martes" ->
                System.out.println("Ese día toca: " + Martes);
            case "Miércoles" ->
                System.out.println("Ese día toca: " + Miércoles);
            case "Jueves" ->
                System.out.println("Ese día toca: " + Jueves);
            case "Viernes" ->
                System.out.println("Ese día toca: " + Viernes);
            default ->
                System.out.println("Esa día no existe, atontao.");
        }
